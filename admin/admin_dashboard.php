...
if (isset($_SESSION['clearSessionStatus'])){
    $ClearSessionMessage = $_SESSION['clearSessionStatus'];
}else{
    $ClearSessionMessage = '';
}
	...
	<?php if($_SESSION['Privilege']=="developer"){ ?>
		<tr>
			...
			<td>
				...
				MySQL database tables. (Requires MySQL credentials for login)
			</td>
		</tr>
		<tr>
